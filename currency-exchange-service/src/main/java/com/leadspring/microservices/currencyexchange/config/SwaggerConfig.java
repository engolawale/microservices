 ...
 */
package com.leadspring.microservices.currencyexchange.config;
...
public class SwaggerConfig {
    ...
    public static final Contact DEFAULT_CONTACT = new Contact("Olawale Ogunbayo", "tpx.com", "kamilu.ogunbayo@tpx.com");
